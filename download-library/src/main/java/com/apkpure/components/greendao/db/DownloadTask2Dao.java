...
*/
public class DownloadTask2Dao extends AbstractDao<DownloadTask2, String> {

    public static final String TABLENAME = "downloadTask";

    /**
     * Properties of entity DownloadTask2.<br/>
    ...
    public DownloadTask2Dao(DaoConfig config) {
        super(config);
    }
    
    public DownloadTask2Dao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DownloadTask2 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DownloadTask2 entity) {
        stmt.clearBindings();
        stmt.bindString(1, entity.getDownloadUrl());
    ...
    @Override
    public DownloadTask2 readEntity(Cursor cursor, int offset) {
        DownloadTask2 entity = new DownloadTask2( //
    ...
    @Override
    public void readEntity(Cursor cursor, DownloadTask2 entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(DownloadTask2 entity, long rowId) {
        return entity.getDownloadUrl();
    }
    
    @Override
    public String getKey(DownloadTask2 entity) {
        if(entity != null) {
            return entity.getDownloadUrl();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DownloadTask2 entity) {
